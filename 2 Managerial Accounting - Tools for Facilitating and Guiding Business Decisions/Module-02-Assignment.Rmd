...
dat %>% kable(caption = 'Cash Flow of Cut Here Inc. within 6 Years')
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/kDPmQ6dNxTk" frameborder="0" allowfullscreen></iframe>
  ...
  - *NPV* for Option A = `r tail(npv$NPV.A, 1) - npv$NPV.A[1]`, therefore it is a profitable investment.
  - *NPV* for Option B = `r tail(npv$NPV.B, 1) - npv$NPV.B[1]`, therefore it is NOT a profitable investment.
