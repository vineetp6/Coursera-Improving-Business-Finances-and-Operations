...
dat2.1 <- data_frame(
  ...
  Actual = c(5500, 132000, '', 22275, 20805, 15860, -58940, 73060, -26500, 46560), 
  
  Standard = c('$2,850 / (1/2 hour per unit) = 5,700 units', '', '', '', '', '', '', '', '', ''), 
  
  Budgeted = c(6000, 120000, '', 23400, 21000, 16500, -60900, 59100, -25000, 34100))

dat2.1 %>% formattable %>% as.htmlwidget
```
...
dat2.2 <- data_frame(
  ...
  Actual = c('8,250 kg / 5,500 Units = 1.5 kg', '$132,000 / 5,500 units = $24 per unit', '', '$22,275 / 5,500 units = $4.05 per unit', '$20,805 / 5,500 units = $3.782727 per unit', '$15,860 / 5,500 units = $2.883636 per unit', '-$58,940 / 5,500 units = $10.71636 per unit == ($4.05 + $3.782727 + $2.883636 = $10.71636 per unit)', '$73,060 / 5,500 units = $13.28364 per unit == ($24 - )', -26500, 46560),
  
  Standard = c('$2,850 / (1/2 hour per unit) = 5,700 Units', '$132,000 / 5,700 units = $23.15789 per unit', '', '$22,275 / 5,700 units = $3.907895 per unit', '$20,805 / 5,700 units = $3.65 per hour', '$15,860 / 5,700 units = $2.782456 per unit', '-$58,940 / 5,700 units = -$10.34035 per unit == (-$3.907895 + $3.65 + $2.782456 = $10.34035 per unit)', '$73,060 / 5,700 units = $12.81754 per unit == ($23.15789 - $10.34035 = $12.81754 per unit)', '$26,500 / 5,700 units = $4.649123 per unit', '$46,560 / 5,700 units = $8.168421 per unit == ($12.81754 - $4.649123 = $8.168417 per unit)'), 
  
  Budgeted = c('9,000 kg / 6,000 units = 1.5 kg', '$120,000 / 6,000 units = $20 per unit', '', '$23,400 / 6,000 units = $3.9 per unit', '$21,000 / 6,000 units = $3.5 per unit', '$16,500 / 6,000 units = $2.75 per unit', '-$60,900 / 6,000 units = $10.15 per unit == ($3.9 + $3.5 + $2.75 = $10.15 per unit)', '$59,100 / 6,000 units = $9.85 per unit === ($20 - $10.15 = $9.85 per unit)', '-$25,000 / 6,000 units = $4.166667 per unit', '$34,100 / 6,000 units = $5.683333 per unit == ($9.85 - $4.166667 = $5.683333 per unit)'))
...
*table 2.2.2: per unit basis statement of Flatland Inc.*
  ...
  By refer to [1.1.3.1 Part 1: Cost Variances], we calculate below answer:

  - **Actual Unit Produced** : 8250 kg ÷ 1.5 kg = `r 8250 / 1.5` units
  - **Direct Labour** : 
  - 
